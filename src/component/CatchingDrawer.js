  ...
  return (
    <div>
      <Flex {...flex_button}>
        <Box margin="auto">
          <Flex align="center">
            <Image {...img_button} src={pokeball} onClick={onOpen}></Image>
          </Flex>
        </Box>
      </Flex>
                ...
                <Box margin="20px 10px">
                  {!catching && firsTry && (
                    <>
                      ...
                      <Box marginTop="10px">
                        <Button {...yes_button} onClick={catchingPokemon}>
                          Yes
                        </Button>
                        <Button {...no_button} onClick={closeCatching}>
                          No
                        </Button>
                      </Box>
                    </>
                      ...
                      {success && (
                        <>
                          ...
                          <Box marginTop="15px">
                            ...
                            <Button {...yes_button} onClick={savePokemon}>
                              Save
                            </Button>
                            <Button {...no_button} onClick={closeCatching}>
                              Cancel
                  ...
                  {catching && (
                    <>
                      ...
                      <CircularProgress
                        ...
                        color="teal.300"
                      />
                      <Text marginTop="15px">Please Wait!!</Text>
                    </>
                  )}
                  <br />
                </Box>
